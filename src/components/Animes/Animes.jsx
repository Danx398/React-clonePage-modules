...
import { BuscadorAvanzado } from "../EnEmision/BuscadorAvanzado/BuscadorAvanzado";
import { CardEmision } from "../EnEmision/CardEmision/CardEmision";
import { Paginador } from "../EnEmision/Paginador/Paginador";
      ...
      <div className="container">
        <div className="row row-cols-4 mt-5">
          {imagenesEmision.map((img) => (
            <CardEmision imageUrl={img.imageUrl} title={img.title} textoOculto={img.sinopsis}/>
          ))}
        </div>
      </div>
      <Paginador/>
